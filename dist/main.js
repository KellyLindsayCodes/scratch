...
if (window.location.pathname === '/index.html' || window.location.pathname === '/') {
  // This code will only execute for the index.html page

  //sphere code
  // ...
  
} else {
  // This code will execute for all other pages except index.html

  // Code for the colored background and other elements
  // ...
  ...
  function getGradientCanvas() {
    // Code for generating gradient canvas
    // ...
  }

  // Mouse event listeners for colored background
  let mouseDown = false;
  let rgb = [];
  ...
  window.addEventListener("mousemove", (e) => {
    if (mouseDown) {
      ...
      gsap.to(gradientMaterial.color, {
        r: newColor.r,
        g: newColor.g,
        b: newColor.b
      });
  ...
  // Rest of your code for the other pages (about.html, contact.html, projects.html)
  // ...
}
